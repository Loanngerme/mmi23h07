 ...
 */
final class Version20250305091048 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE garage (id INT AUTO_INCREMENT NOT NULL, voiture_id INT DEFAULT NULL, nom_garage VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_9F26610B181A8BA (voiture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
