 ...
 */
final class Version20250305095619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE garage ADD lieu_id INT DEFAULT NULL, ADD voiture_nom_id INT DEFAULT NULL, ADD nom_garage VARCHAR(255) NOT NULL, CHANGE nom_garage_id voiture_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE garage ADD CONSTRAINT FK_9F26610BEBE6D6F3 FOREIGN KEY (voiture_nom_id) REFERENCES voiture (id)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9F26610BEBE6D6F3 ON garage (voiture_nom_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE garage DROP FOREIGN KEY FK_9F26610BEBE6D6F3');
        $this->addSql('DROP INDEX UNIQ_9F26610B181A8BA ON garage');
        $this->addSql('DROP INDEX IDX_9F26610B6AB213CC ON garage');
        $this->addSql('DROP INDEX UNIQ_9F26610BEBE6D6F3 ON garage');
        $this->addSql('ALTER TABLE garage ADD nom_garage_id INT DEFAULT NULL, DROP voiture_id, DROP lieu_id, DROP voiture_nom_id, DROP nom_garage');
