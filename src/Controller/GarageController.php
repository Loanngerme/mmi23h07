...
final class GarageController extends AbstractController
{
    ...
    #[Route('/admin/garage/new', name: 'app_garage_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/admin/garage/{id}', name: 'app_garage_show', methods: ['GET'])]
    ...
    #[Route('/admin/garage/{id}/edit', name: 'app_garage_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/admin/garage/{id}', name: 'app_garage_delete', methods: ['POST'])]
